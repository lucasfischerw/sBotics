...
async Task Vermelho() {
    if(Bot.GetComponent<ColorSensor>("S2").Analog.Red > 160 && Bot.GetComponent<ColorSensor>("S2").Analog.Red > Bot.GetComponent<ColorSensor>("S2").Analog.Green + 35) {
        Parar();
    }
}
...
async Task Redzone() {
    if(Bot.GetComponent<ColorSensor>("S0").Analog.Blue >= Bot.GetComponent<ColorSensor>("S0").Analog.Red && Bot.GetComponent<ColorSensor>("S0").Analog.Blue  > Bot.GetComponent<ColorSensor>("S0").Analog.Green && Bot.GetComponent<ColorSensor>("S0").Analog.Red  < 150) {
        if(Bot.GetComponent<ColorSensor>("S3").Analog.Blue >= Bot.GetComponent<ColorSensor>("S3").Analog.Red && Bot.GetComponent<ColorSensor>("S3").Analog.Blue  > Bot.GetComponent<ColorSensor>("S3").Analog.Green && Bot.GetComponent<ColorSensor>("S3").Analog.Red  < 150) {
            MoverMotores(300,300);
            ...
            while(DateTimeOffset.Now.ToUnixTimeMilliseconds() - Tempo_Inicial < 1000) {
                ...
                MoverMotores(300,300);
                await Time.Delay(25);
                if(Bot.GetComponent<UltrasonicSensor>("frontLeftDistance").Analog < 0) {
                    await Girar(-90,1);
