...
async Task Redzone() {
    if(Bot.GetComponent<ColorSensor>("S2").Analog.Blue > Bot.GetComponent<ColorSensor>("S2").Analog.Red+2 && Bot.GetComponent<ColorSensor>("S2").Analog.Blue  > Bot.GetComponent<ColorSensor>("S2").Analog.Green && Bot.GetComponent<ColorSensor>("S2").Analog.Red  < 130) {
        IO.Print("Redzone");
        ...
        while(Bot.GetComponent<UltrasonicSensor>("UltraFrente").Analog > 0) {
